...
async function getReporte() {
  const rawResponse = await fetch("https://servidor-ipc1-201901598.herokuapp.com/imagenes/reporte", {
    method: "GET",
  ...
  const rawResponse2 = await fetch("https://servidor-ipc1-201901598.herokuapp.com/videos/reporte", {
    method: "GET",
    headers: { "Content-Type": "application/json" },
  });
  ...
  // Arreglo de claves
  const edades2_ = Object.keys(response2.data)

  // Arreglo de valores
  const valores2_ = Object.values(response2.data)
